    ...
    <Container maxWidth="sm"
        ...
        <Paper elevation={3} style={{padding: 32, borderRadius: 18, marginTop: 48, textAlign: 'center'}}>
            ...
            <Typography variant="body1" style={{marginBottom: 18, color: '#444', fontSize: '1.1rem'}}>
                The Fawley & The Waterside Dog Show is a community event led entirely by dedicated volunteers. Our
                mission is to bring people and their dogs together for a day of fun, friendship, and fundraising.
            </Typography>
            <Typography variant="body1" style={{marginBottom: 18, color: '#444', fontSize: '1.1rem'}}>
                We are proud to support cancer research. In August 2025, thanks to your generosity, we
                raised <b>£1,000</b> for Southampton Hospital Cancer Research. Every ticket, donation, and helping hand
