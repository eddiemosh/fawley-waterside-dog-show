        ...
        <Container maxWidth="sm"
            ...
            <Paper elevation={3} style={{padding: 32, borderRadius: 18, marginTop: 48, textAlign: 'center'}}>
                ...
                <Typography variant="body1" style={{marginBottom: 24, color: '#444', fontSize: '1.15rem'}}>
                    Your generosity helps us continue our mission to support cancer research and make a difference in
                    the lives of those affected. Every contribution, big or small, brings us closer to a world where
                    cancer can be beaten. We are deeply grateful for your support and for joining us in this important
                    cause.
                </Typography>
