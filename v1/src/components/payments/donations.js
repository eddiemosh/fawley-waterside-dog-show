        ...
        <Container maxWidth="sm"
            ...
            <Paper elevation={3} style={{padding: 32, borderRadius: 18, marginTop: 48}}>
                ...
                <Typography variant="body1" align="center" style={{marginBottom: 18, color: '#444'}}>
                    At Fawley & The Waterside Dog Show, we are committed to making a difference in the fight against
                    cancer. Every donation goes directly to supporting vital cancer research, helping to save lives and
                ...
                <Box display="flex" flexDirection="column" alignItems="center" gap={2}>
                    ...
                    <TextField
                        ...
                        inputProps={{
                            inputMode: 'decimal',
                            pattern: '[0-9]*',
                            style: {textAlign: 'center', fontSize: '1.3rem', fontWeight: 600}
                        }}
                        style={{width: 200, marginBottom: 8}}
